...
const FoxBot = ({ properties, setView, setSelectedProperty, userName, user }) => {
    ...
    const [messages, setMessages] = useState([
        {
            id: 1,
            type: 'bot',
            text: `Hi! I am Fox. 🦊 I'm a clever assistant here to help you find the best property masterpieces. What's on your mind?`
        }
    ]);
    ...
    const processResponse = (query) => {
        ...
        if (isSearchQuery) {
            ...
            responseText = `I am Fox! 🦊 Your clever real estate guide. I help you find properties that fit your legend. Just tell me what location or type you're looking for!`;
        } else {
                ...
                <div className="glass" style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            <FoxAvatar size={45} />
                            <div>
                                <h4 style={{ color: '#ff8c00', fontSize: '1.1rem', margin: 0 }}>Fox AI</h4>
                    ...
                    <div style={{ padding: '20px', borderTop: '1px solid rgba(255,140,0,0.1)' }}>
                        <div style={{
                            ...
                            <input
                                placeholder="Track down property with Fox..."
